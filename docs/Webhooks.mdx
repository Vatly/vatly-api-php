export const metadata = {
  title: 'Webhooks (PHP SDK)',
  description:
    'Learn how to handle Vatly webhooks in your PHP application.',
}

# Webhooks

Vatly sends webhooks to notify your application when events happen, like successful checkouts, subscription renewals, or chargebacks. {{ className: 'lead' }}
