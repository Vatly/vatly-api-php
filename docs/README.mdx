...
Official PHP SDK for the Vatly API. Handle subscriptions, one-off payments, tax compliance, and billing for your SaaS. {{ className: 'lead' }}
...
<Row>
  <Col>
    ...
    <Properties>
      <Property name="live_" type="prefix">
        Production transactions, real charges.
      </Property>
      <Property name="test_" type="prefix">
...
<Row>
  <Col>
    ...
    <Properties>
      <Property name="ValidationException" type="exception">
        Invalid request parameters. Check `getErrors()` for field-level details.
      </Property>
      <Property name="ApiException" type="exception">
        API errors (network, authentication, etc.). Check `getStatusCode()` for HTTP status.
      </Property>
    </Properties>
